...
def train_yolo(data_yaml, model='yolov8n.pt', epochs=50, imgsz=640, batch=16, device='0'):
    ...
    print(f"Best model saved to: runs/detect_peanuts/train/weights/best.pt")
    print(f"Last model saved to: runs/detect_peanuts/train/weights/last.pt")
    print(f"{'='*60}\n")
